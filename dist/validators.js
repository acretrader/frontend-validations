...
export const maxDate = (param) => withParams({ type: 'maxDate', value: param }, (value) => (!requiredValidator(value) || +(new Date(value)) <= +(new Date(param))));
export const minDate = (param) => withParams({ type: 'minDate', value: param }, (value) => (!requiredValidator(value) || +(new Date(value)) >= +(new Date(param))));
/**
...
export const eql = (param) => withParams({ type: 'eql', value: param }, (value) => (!requiredValidator(value) || value === param));
export const equal = eql;
export const notEql = (param) => withParams({ type: 'notEql', value: param }, (value) => (!requiredValidator(value) || value !== param));
export const required = (param) => withParams({ type: 'required', value: param }, requiredValidator);
export const requiredIf = (param) => withParams({ type: 'requiredIf', value: param }, (value, model) => (model[param] ? requiredValidator(value) : true));
/**
 ...
 * @returns boolean
 */
export const requiredIfAtRoot = (param, rootModel) => withParams({ type: 'requiredIfAtRoot', value: param }, (value) => (get(rootModel, param) ? requiredValidator(value) : true));
/**
...
export const requiredUnless = (param) => withParams({ type: 'requiredUnless', value: param }, (value, model) => (!get(model, param) ? requiredValidator(value) : true));
export const requiredUnlessAtRoot = (param, rootModel) => withParams({ type: 'requiredUnlessAtRoot', value: param }, (value) => (!get(rootModel, param) ? requiredValidator(value) : true));
/**
...
export const regex = (param) => withParams({ type: 'regex', value: param }, (value) => (!requiredValidator(value) || new RegExp(param).test(value)));
export const password = (param) => withParams({ type: 'password', value: param }, (value) => !requiredValidator(value) || /\S{8,}/.test(value));
export const email = (param) => withParams({ type: 'email', value: param }, (value) => !requiredValidator(value) || emailRegex.test(value));
...
export const minLength = (param) => withParams({ type: 'minLength', value: param }, (value) => (!requiredValidator(value) || getLength(value) >= param));
export const maxLength = (param) => withParams({ type: 'maxLength', value: param }, (value) => (!requiredValidator(value) || getLength(value) <= param));
export const minValue = (param) => withParams({ type: 'minValue', value: param }, (value) => (!requiredValidator(value) || ((!/\s/.test(value) || value instanceof Date) && +value >= +param)));
export const maxValue = (param) => withParams({ type: 'maxValue', value: param }, (value) => (!requiredValidator(value) || ((!/\s/.test(value) || value instanceof Date) && +value <= +param)));
